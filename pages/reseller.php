...
if (isset($_POST['update'])) {
 $u->updateReseller($_POST);
}
if (isset($_POST['delete'])) {
    $u->deleteReseller($_POST['id']);
}
...
<div class="app-content">
    ...
    <div class="content-wrapper">
        <div class="container">
            <h2 class="my">Reseller's List</h2>
      ...
      <div class="card-header d-flex justify-content-between">
          <!--       <form action="" method="POST">
                ...
                <div class="d-flex justify-content-right">
                    ...
                    <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#addReseller"><i class="material-icons-outlined">add</i>Add Reseller</button>
                </div>
            </div> 
            <div class="row">
                <div class="col">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <h5 class="card-title">Reseller's List</h5>
...
<th>Payment G</th><th>Action</th>
                                ...
                                <tbody>
                                    <?php foreach ($u->getAllReseller() as $c) : ?>
                                        <tr>
                                           
                                            <td><a href="#editReseller" class="modal-trigger" data-bs-toggle="modal" data-uid="<?php echo $c['Reseller_id']; ?>" data-uname="<?php echo $c['u_name']; ?>" data-uemail="<?php echo $c['u_email']; ?>"   data-mnum="<?php echo $c['u_num']; ?>"  data-country="<?php echo $c['u_country']; ?>"><?= $c['u_email'] ?></a></td>
                                             <td><?=  $c['u_name'] ?></td>
                                            <td><?= $c['u_num'] ?></td>
...
<div class="modal fade" id="editReseller" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="Resellername" class="form-label">Reseller Name</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="update" class="btn btn-primary">Update Reseller</button>
                </form>
            </div>
        </div>
    </div>
...
<!-- Modal -->
<div class="modal fade" id="addReseller" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <select name="country" id="country" class="form-control" tabindex="-1" style="display: none; width: 100%" >
                        <?php foreach ($u->allCountry() as $d) : ?>
                            <option value="<?php echo $d['id']; ?>" ><?php echo $d['country_name']; ?></option>
                        <?php endforeach; ?>
                    </select>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <button type="submit" name="submit" class="btn btn-primary">Add Reseller</button>
                </form>
            </div>
        </div>
    </div>
...
$(document).on('click','.status_checks',function(){
      ...
      url = "http://localhost/whatsap/php/Home.php/Reselleractivation()";
